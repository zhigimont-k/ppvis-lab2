...
public class ListViewPanel extends DisplayPanel {
    DefaultListModel listModel;

    public ListViewPanel(ConsistDirectoryPanel consistDirectoryPanel, String directoryName, ChooseFilePanel chooseFilePanel) {
